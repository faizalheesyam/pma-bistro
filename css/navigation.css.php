...
#pma_navigation {
    ...
    color: #ffffff; <?php // echo $GLOBALS['cfg']['NaviColor']; ?>;
    z-index: 800;
}
...
#pma_navigation_tree a {
    color: #cccccc; <?php // echo $GLOBALS['cfg']['NaviColor']; ?>;
}
#pma_navigation_tree a:hover {
    text-decoration: none;
}
#pma_navigation_tree li.activePointer {
    color: #f0f0f0; <?php // echo $GLOBALS['cfg']['NaviPointerColor']; ?>
    background-color: #444444; <?php // echo $GLOBALS['cfg']['NaviPointerBackground']; ?>
}
